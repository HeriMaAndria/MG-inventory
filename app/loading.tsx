      ...
      <div className="text-center relative z-10">
        ...
        <div className="relative mb-8">
          ...
          <div className="relative h-32 w-32 mx-auto">
            ...
            <div className="absolute inset-2 rounded-full border-4 border-transparent border-b-emerald-500 border-l-emerald-500 animate-spin" style={{ animationDuration: '2s' }}></div>
          ...
          <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-3 h-3 bg-emerald-400 rounded-full animate-ping" style={{ animationDelay: '0.5s' }}></div>
          <div className="absolute top-1/2 left-0 -translate-y-1/2 w-2 h-2 bg-green-300 rounded-full animate-ping" style={{ animationDelay: '1s' }}></div>
          <div className="absolute top-1/2 right-0 -translate-y-1/2 w-2 h-2 bg-emerald-300 rounded-full animate-ping" style={{ animationDelay: '1.5s' }}></div>
        </div>
        ...
        <div className="flex justify-center space-x-3 mt-6">
          ...
          <div className="w-3 h-3 bg-emerald-500 rounded-full animate-bounce shadow-lg shadow-emerald-500/50" style={{ animationDelay: '0.1s' }}></div>
          <div className="w-3 h-3 bg-green-400 rounded-full animate-bounce shadow-lg shadow-green-400/50" style={{ animationDelay: '0.2s' }}></div>
        </div>
